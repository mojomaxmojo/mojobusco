...
- [ ] Schritt 1 — `server/config/media-paths.js` (FFMPEG/FFPROBE/MUSIC_DIR/TMP_DIR)
- [ ] Schritt 2 — `server/config/music-prompts.js` (ZOOM_PAN_EFFECTS/ASPECT_SIZES/LIFESTYLE_MUSIC_PROMPTS)
