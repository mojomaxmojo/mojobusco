...
export function StrandOrt() {
  ...
  useHead({
    ...
    link: [
      { rel: 'canonical', href: canonicalUrl('/artikel/strand-ort') }
    ]
  });
  ...
  // Icon mapping for Strand/Ort categories
  const getStrandOrtIcon = (iconName: string) => {
    switch (iconName) {
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <Link to="/artikel/strand-ort">
            <Button variant="outline">
              Zurück zur Strand/Ort Übersicht
            </Button>
          </Link>
        </div>
      </div>
          ...
          <div className="text-center space-y-4">
            ...
            <h1 className="text-4xl md:text-6xl font-bold">
              <span className="gradient-text">
                {currentCategory ? currentCategory.name : '🏖️ Strand/Ort'}
              </span>
            </h1>
            <p className="text-xl text-muted-foreground">
              {currentCategory
                ? currentCategory.description
                : 'Strände, Berge, Wälder, Meer und besondere Orte'
              }
            </p>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 pb-8">
        ...
        {!category && (
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {Object.values(STRANDORT_CONFIG.categories).map((cat) => {
                const Icon = getStrandOrtIcon(cat.icon);
                return (
        ...
        <div className="mb-6">
          <div className="relative">
            ...
            <Input
              placeholder="Strand/Ort Artikel durchsuchen..."
              value={searchTerm}
        ...
        <div className="space-y-6">
          ...
          {isDemoMode && !isLoading && !error && (
            <Card className="border-dashed border-cyan-200 dark:border-cyan-900">
              <CardContent className="py-8 px-8">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Zeige alle Artikel - keine Strand/Ort Kategorien gefunden
                    </p>
                  </div>
                </div>
              </CardContent>
...
const StrandOrtArticleCard = memo(function StrandOrtArticleCard({ article }: { article: NostrEvent }) {
  const metadata = extractArticleMetadata(article);
